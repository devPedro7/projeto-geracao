...
export const Products: IProductCard[] = [
  {
    ...
    description:
      'Clássico tênis Nike Jordan, perfeito para jogar aquele basquete.',
  ...
  },
  {
    ...
    brand: ProductBrand.NIKE,
    gender: ProductGender.MALE,
    name: "Nike Air Jordan 11 Retro '98'",
    price: 1499.99,
    discount: 30,
    size: '38, 39, 40, 41, 42, 43',
    image:
    ...
    description:
      'Tênis Nike Air Jordan 11 moderno, ideal para uso diário e casual.',
  ...
  },
  {
    ...
    brand: ProductBrand.NIKE,
    gender: ProductGender.MALE,
    name: "Nike Air Jordan 11 Retro Bone Snakeskin'",
    price: 1499.99,
    discount: 30,
    size: '38, 39, 40, 41, 42, 43',
    image:
